...
class Receiver:
    ...
    def is_ptz_supported(self) -> Any: ...
    def set_zoom_level(self, zoom_value: float) -> Any: ...
    def zoom(self, zoom_value: float) -> Any: ...
    def pan_and_tilt(self, pan_speed: float, tilt_speed: float) -> Any: ...
    def pan(self, pan_speed: float) -> Any: ...
    def tilt(self, tilt_speed: float) -> Any: ...
    def set_pan_and_tilt_values(self, pan_value: float, tilt_value: float) -> Any: ...
    def store_preset(self, preset_no: int) -> Any: ...
    def recall_preset(self, preset_no: int, speed: float) -> Any: ...
    def autofocus(self) -> Any: ...
    def set_focus(self, focus_value: float) -> Any: ...
    def focus(self, focus_speed: float) -> Any: ...
    def white_balance_auto(self) -> Any: ...
    def white_balance_indoor(self) -> Any: ...
    def white_balance_outdoor(self) -> Any: ...
    def white_balance_oneshot(self) -> Any: ...
    def set_white_balance(self, red: float, blue: float) -> Any: ...
    def exposure_auto(self) -> Any: ...
    def set_exposure_coarse(self, iris: float, gain: float, shutter_speed: float) -> Any: ...
